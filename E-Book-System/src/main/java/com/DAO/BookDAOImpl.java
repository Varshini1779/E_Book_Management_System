...
public class BookDAOImpl implements BookDAO {
	...
	public List<BookDtls> getRecentBooks() {
		...
		try {
			String sql = "SELECT * FROM book_dtls WHERE bookCategory='New' AND status='Active' ORDER BY bookId DESC LIMIT 4";
			PreparedStatement ps = conn.prepareStatement(sql);
	...
	public List<BookDtls> getAllRecentBook() {
		...
		try {
			String sql = "SELECT * FROM book_dtls WHERE bookCategory='New' AND status='Active' ORDER BY bookId DESC";
			PreparedStatement ps = conn.prepareStatement(sql);
			ResultSet rs = ps.executeQuery();
